...
void setPinMapping(byte boardID)
{
  ...
  switch (boardID)
  {
   ...
   case 31:
     ...
     #elif defined(STM32F407xx)
      pinInjector1 = PE15; //Output pin injector 1
      pinInjector2 = PE14; //Output pin injector 2
      pinInjector3 = PE13; //Output pin injector 3
      pinInjector4 = PE12; //Output pin injector 4
      pinInjector5 = PE11; //Output pin injector 5
      pinInjector6 = PE10; //Output pin injector 6
      pinInjector7 = PE9; //Output pin injector 7 (placeholder)
      pinInjector8 = PE8; //Output pin injector 8 (placeholder)
      pinCoil1 = PD12; //Pin for coil 1
      pinCoil2 = PD13; //Pin for coil 2
      pinCoil3 = PB15; //Pin for coil 3
      pinCoil4 = PB14; //Pin for coil 4
      pinCoil5 = PD8; //Pin for coil 5
      pinCoil6 = PD9; //Pin for coil 6
      pinCoil7 = PD11; //Pin for coil 7 (placeholder)
      pinCoil8 = PD10; //Pin for coil 8 (placeholder)
      ...
      pinBaro = PB1; //Baro sensor pin
      //pinDisplayReset = PE12; // OLED reset pin
      pinTachOut = PE5; //Tacho output pin  (Goes to ULN2003)
      pinIdle1 = PC6; //ICV pin1
      //pinIdle2 = PD9; //ICV pin3
      pinBoost = PC7; //Boost control
      pinVVT_1 = PD14; //VVT1 output (intake vanos)
      //pinVVT_2 = PD; //VVT2 output (exhaust vanos)
      pinFuelPump = PE3; //Fuel pump output  (Goes to ULN2003)
      pinStepperDir = PC9; //Stepper valve isn't used with these
      pinStepperStep = PC8; //Stepper valve isn't used with these
      pinStepperEnable = PA8; //Stepper valve isn't used with these
      pinFan = PE2; //Pin for the fan output (Goes to ULN2003)
      pinLaunch = PE1; //Launch control pin
